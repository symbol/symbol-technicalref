...
A \nind{private key} is a random 256-bit integer $k$ represented as sixty-four hexadecimal digits. To derive the public key \underline{A} from it, the following steps are taken:
\begin{align}
H(k) &=(h_0, h_1,..., h_{511}) \\
