...
The behavior of \codename, in such a case, can be configured either to exit the server or to discard new data until a slot becomes available.
...
This consumer completes processing the element and frees all memory associated with it.
