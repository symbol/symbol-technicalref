...
Consumers can set an element's completion status to {\it Aborted} in case it is already known or invalid for some reason.
...
The hash check consumer uses the hashes to search the recency cash, which contains the hashes of all recently seen elements.
