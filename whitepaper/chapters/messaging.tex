...
\begin{figure}[H]
	\nemmemorylayout{
		...
		\\
		\nemmemorymultiwordbox{body part 1 - 0x00}{SignerPublicKey}{3} \\
		\nemmemorymultiwordbox{body part 1 - 0x20}{Signature}{7} \\
		\nemmemorymultiwordbox{body part 1 - 0x60}{ParentHash}{3}
