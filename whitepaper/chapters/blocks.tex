	...
	\nemcenterwithcaption{
		...
		\begin{subfigure}{.33\textwidth}
			\nemmemorylayout{
				...
				\end{leftwordgroup} \\
				\nemmemorymultiwordbox{\texttt{0x88}}{PreviousBlockHash}{3} \\
				\nemmemorymultiwordbox{\texttt{0xA8}}{TransactionsHash}{3} \\
				\nemmemorymultiwordbox{\texttt{0xC8}}{ReceiptsHash}{3} \\
				\nemmemorymultiwordbox{\texttt{0xE8}}{StateHash}{3} \\
				\nemmemorymultiwordbox{\texttt{0x108}}{\small BeneficiaryPublicKey}{3} \\
		...
		\begin{subfigure}{.33\textwidth}
			\nemmemorylayout{
				...
				\end{leftwordgroup} \\
				\nemmemorymultiwordboxskipped{\texttt{0x130}}{Transactions}{}
			}{Unverifiable footer}
		\end{subfigure}
...
\texttt{FeeMultiplier} is a multiplier that is used to calculate the effective fee of each transaction contained within a block.
	...
	\nemcenterwithcaption{
		\begin{subfigure}{.5\textwidth}
			\nemmemorylayout{
				...
				\end{leftwordgroup} \\
				\nemmemorymultiwordboxskipped{\texttt{0x10}}{Receipts}{} \\
	...
	\nemcenterwithcaption{
		\begin{subfigure}{.5\textwidth}
			\nemmemorylayout{
				...
				\end{leftwordgroup} \\
				\nemmemorymultiwordboxskipped{\texttt{0x10}}{Resolution}{Entries} \\
...
When a network is configured with \nemsetting{network}{enableVerifiableReceipts}, the root hash of this merkle tree is set as the block's \texttt{ReceiptHash}.
